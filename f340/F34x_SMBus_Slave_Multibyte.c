...
// Program Description:
//
// Example software to demonstrate the C8051F34x SMBus interface in Slave mode
...
// How To Test:
//
// 1) Download code to a 'F34x device that is connected to a SMBus master.
...
#define  SLAVE_ADDR     0xEE           // Device addresses (7 bits,
                                       // lsb is a don't care)
...
void SMBus_ISR (void) interrupt 7
{
   ...
   static unsigned char tmp_counter;
